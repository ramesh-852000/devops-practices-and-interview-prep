...
- Neutron interacts with:
  _ Keystone - authorize API calls
  _ Nova - nova communicates with neutron to plug NICs into a network \* Horizon - supports networking entities in the dashboard and also provides topology view which includes networking details
  </b></details>
